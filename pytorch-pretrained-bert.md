...
bash run_absa.sh ae laptop_pt_review laptop pt_ae_review 9 0
bash run_absa.sh ae rest_pt_review rest pt_ae_review 10 0
bash run_absa.sh asc laptop_pt_review laptop pt_asc_review 10 0
bash run_absa.sh asc rest_pt_review rest pt_asc_review 10 0
```
step5: evaluation
